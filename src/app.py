...
def predecir():
    ...
    # Convertir a array e invertir colores (blanco sobre negro)
    imagen_array = 255 - np.array(imagen)

    # Binarizar con umbral más bajo
    ...
    # Crear imagen cuadrada agregando padding para centrar
    ...
    # Guardar para ver si ya está bien
